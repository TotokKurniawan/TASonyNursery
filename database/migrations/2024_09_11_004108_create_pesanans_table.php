...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('pesanans', function (Blueprint $table) {
            ...
            $table->enum('status', ['pending', 'in_progress', 'completed', 'canceled', 'negosiasi'])->default('pending'); // Enum for status
            ...
            $table->string('waktu_pengerjaan')->nullable(); // Payment method
            $table->date('tanggal_pengerjaan')->nullable(); // Payment method
            $table->string('keterangan_tambahan')->nullable(); // Payment method
            $table->string('keterangan_banding')->nullable(); // Payment method
            $table->string('keterangan_tolak')->nullable(); // Payment method
            $table->enum('status_pembayaran', ['belum lunas', 'dp', 'lunas'])->default('pending');
